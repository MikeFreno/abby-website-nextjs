...
function hideModal() {
  document.getElementById("pm-container")?.classList.add("hidden");
  document.querySelector("body")?.classList.remove("overflow-y-hidden");
}

function Photographer_modal() {
  return (
    <div id="pm-container" className="hidden">
...
export default Photographer_modal;
